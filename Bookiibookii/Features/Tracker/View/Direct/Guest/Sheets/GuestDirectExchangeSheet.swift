...
// 안드 fragment_direct_guest_exchange_bottom_dialog.xml (DirectGuestExchangeBottomDialogFragment) 대응.
// SHIPPING_TO_HOST (약속 시간 경과) — 게스트가 호스트에게 책을 반납했는지 확인.
struct GuestDirectExchangeSheet: View {
