...
// 안드 fragment_direct_host_extend_request_bottom_dialog.xml (DirectHostExtendRequestBottomDialogFragment) 대응.
// GUEST_EXTENSION — 게스트가 신청한 연장을 호스트가 확인.
struct HostDirectExtendRequestSheet: View {
...
#Preview("HostDirectExtendRequest") {
