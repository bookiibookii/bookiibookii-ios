...
// 안드 fragment_direct_host_appointment_status_bottom_dialog.xml (DirectHostAppointmentStatusBottomDialogFragment) 대응.
// SHIPPING_TO_HOST (약속 시간 미경과) — 호스트가 회수 약속 상태 보는 시트. 단일 댓글 진입 버튼만.
struct HostDirectAppointmentStatusSheet: View {
...
#Preview("HostDirectAppointmentStatus") {
