...
// 안드 fragment_direct_host_extend_period_dialog.xml (DirectHostExtendPeriodDialogFragment) 대응.
// 호스트 본인 독서 기간 연장 신청 다이얼로그. 일수 1~7 입력.
struct HostDirectExtendPeriodSheet: View {
...
#Preview("HostDirectExtendPeriod") {
    HostDirectExtendPeriodPreview()
}

private struct HostDirectExtendPeriodPreview: View {
    @State var days = ""
    var body: some View {
        ZStack {
