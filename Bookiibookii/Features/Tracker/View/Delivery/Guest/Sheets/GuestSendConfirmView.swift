...
// 안드 fragment_guest_send_confirm.xml (GuestSendConfirmFragment) 대응.
// 호스트의 수령 인증 사진을 게스트가 검수 후 서버에 verifyReception patch.
struct GuestSendConfirmView: View {
    let imageUrl: String?
...
private struct StatefulPreview: View {
    ...
    var body: some View {
        ZStack {
            ...
            GuestSendConfirmView(imageUrl: nil, isChecked: $checked, onConfirm: {})
                .padding(20)
        }
    }
}
