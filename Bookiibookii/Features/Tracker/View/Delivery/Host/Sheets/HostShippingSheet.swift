...
// 안드 fragment_host_shipping_bottom_dialog.xml (HostShippingBottomDialogFragment) 대응.
// HOST_DONE — 호스트 완독, 게스트 배송지로 발송할 운송장 등록 진입.
struct HostShippingSheet: View {
...
#Preview("HostShipping") {
    ZStack(alignment: .bottom) {
        Color("grey100").ignoresSafeArea()
        HostShippingSheet(
            receiverName: "홍길동",
            receiverPhone: "010-0000-0000",
            address: "[06234] 서울특별시 강남구 테헤란로 123 4층",
            onCopy: {},
            onRegister: {}
        )
    }
